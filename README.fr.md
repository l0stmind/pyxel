...
Grâce à ses spécifications simples inspirées des consoles de jeux rétro, telles que seulement 16 couleurs peuvent être affichées et seulement 4 sons peuvent être lus en même temps, vous pouvez vous sentir libre de profiter de la création de jeux de style pixel art.
